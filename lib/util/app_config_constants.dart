...
class AppConfigConstants {
  ...
  static String googleMapApiKey =
      settingsController.setting.value?.googleMapApiKey ?? "";

  // make user "/" is added at the end of url
  // static const restApiBaseUrl = 'rest_api_url';
  // static const restApiBaseUrl = 'https://sayhi.codepearl.in/api/web/v1/';
  static const restApiBaseUrl = 'https://alist.sataware.dev/api/web/v1/';

  // make user "/" is added at the end of url
  // Socket api url
  static const socketApiBaseUrl = "https://alist.sataware.dev:4000";
